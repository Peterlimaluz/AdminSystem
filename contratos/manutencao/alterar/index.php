...
<html>
<head>
<title>Reparsul | Manutenção :: Alterar</title>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="search-box">
					<form class="input">
						<a href="#" style="color: slateblue; font-weight: 600; text-transform: uppercase;"><div class="titlePg">Contrato Manutenção</div></a>
					</form>
				</div><!--//end-search-box-->
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">border_color </i> Alterar Contrato de Manutenção</h3>
...
$query = 'SELECT DISTINCT * FROM manutencao ORDER BY ma_id DESC LIMIT '.$begin.' , 10';
$query = mysql_query($query);
