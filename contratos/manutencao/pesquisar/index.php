...
<html>
<head>
<title>Reparsul | Manutenção :: Pesquisar</title>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="search-box">
					<form class="input">
						<a href="#" style="color: slateblue; font-weight: 600; text-transform: uppercase;"><div class="titlePg">Manutenção</div></a>
					</form>
				</div><!--//end-search-box-->
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">border_color </i> Pesquisar Cadastros de Contratos de Manutenção</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Clique no botão do campo que será utilizado para pesquisar os Contratos de Manutenção:</h4>
						<br>
						<hr>
							  ...
							  <div class="modal-dialog">
								<div class="modal-content">
								  ...
								  <div class="modal-body">
									<form name="form_dtgerar" method="post">
										<div class="row">
								  ...
								  <div class="modal-footer">
										...
										<button type="submit" class="btn btn-success" onclick="excel();" ><i class="fa fa-file-excel"></i> Excel</button>
												  ...
												  <script language="Javascript">
													function buscar()
													{
														document.form_dtgerar.action = "pesquisa-dtgerar.php";
														// document.Form1.target = "_blank";    // Open in a new window
														document.form_dtgerar.submit();             // Submit the page
														return true;
													}

													function excel()
													{
														document.form_dtgerar.action = "excel/excel-dtgerar.php"
						...
						<button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#cpf">
										...
										<div class="modal-content">
										  <div class="modal-header">
											...
											<h4 class="modal-title" id="Cnpj">Pesquisa por Cpf/Cnpj</h4>
											  ...
											  <div class="modal-footer">
													<button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
													<input type="submit" class="btn btn-info" onclick="buscarT();" value="Buscar"/>
													<button type="submit" class="btn btn-success" onclick="excelT();" ><i class="fa fa-file-excel"></i> Excel</button>
												 </form>
												  <script language="Javascript">
													function buscarT()
													{
										...
										<div class="modal-content">
										  <div class="modal-header">
											...
											<h4 class="modal-title" id="contra">Pesquisa por Número de Contrato</h4>
											  ...
											  <div class="modal-footer">
													<button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
													<input type="submit" class="btn btn-info" onclick="buscarTr();" value="Buscar"/>
													<button type="submit" class="btn btn-success" onclick="excelTr();" ><i class="fa fa-file-excel"></i> Excel</button>
												 </form>
												  <script language="Javascript">
													function buscarTr()
													{
								...
								<button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#Pg">
								  Pagamento
								</button>
								<!-- Modal -->
								<div class="modal fade" id="Pg" tabindex="-1" role="dialog" aria-labelledby="forma" aria-hidden="true">
							 		<div class="modal-dialog">
										<div class="modal-content">
										  <div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
											<h4 class="modal-title" id="forma">Pesquisa por Forma de Pagamento</h4>
											  ...
											  <div class="modal-footer">
													<button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
													<input type="submit" class="btn btn-info" onclick="buscarFo();" value="Buscar"/>
													<button type="submit" class="btn btn-success" onclick="excelFo();" ><i class="fa fa-file-excel"></i> Excel</button>
												 </form>
												  <script language="Javascript">
													function buscarFo()
													{
							...
							<div class="modal fade" id="dtGera" tabindex="-1" role="dialog" aria-labelledby="gera" aria-hidden="true">
							  <div class="modal-dialog">
								<div class="modal-content">
								  ...
								  <div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
										<input type="submit" class="btn btn-info" onclick="buscarFi();" value="Buscar"/>
										<button type="submit" class="btn btn-success" onclick="excelFi();" ><i class="fa fa-file-excel"></i> Excel</button>
												 </form>
												  <script language="Javascript">
													function buscarFi()
													{
