...
<html>
<head>
<title>Reparsul | Vendas :: Impressão</title>
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">search </i> - TELA DE IMPRESSÃO DO CONTRATO VENDA</h3>
...
$query = "SELECT ve_id FROM contrato_vendas ORDER BY ve_id DESC LIMIT 1";
$query = mysql_query($query);
...
?> 
						<div class="row">
							<div align="center" class="col-md-12 col-xs-12">
								<label>Código de Controle de Pátio : </label><label class="alert alert-success"> <?php echo $linha['ve_id']?></label>
							</div>
						</div>
						<br>
						<div class="row">
