...
<html>
<head>
<title>Reparsul | Orçamento :: Vendas</title>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="search-box">
					<form class="input">
						<a href="../locacoes/"><div class="titlePg">Vendas</div></a>						
					</form>
				</div><!--//end-search-box-->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms validation">
					<h3 class="title1">Vendas</h3>
					<small>Escolha uma das opções abaixo.</small>
					<div class="form-three widget-shadow">
						<div align="center" data-example-id="form-validation-states"> 
							<a class="btn btn-success btn-lg" href="gerar/" style="width: 100%; text-transform: uppercase;"><i class="material-icons">note_add </i> Gerar contrato de vendas</a>
						</div>
					</div>	
					<div class="form-three widget-shadow">
						<div align="center" data-example-id="form-validation-states"> 
							<a class="btn btn-primary btn-lg" href="alterar/" style="width: 100%; text-transform: uppercase;"><i class="material-icons">create </i> ALTERAR contrato de vendas</a>
						</div>
					</div>	
					<div class="form-three widget-shadow">
						<div align="center" data-example-id="form-validation-states"> 
							<a class="btn btn-danger btn-lg" href="pesquisar/" style="width: 100%; text-transform: uppercase;"><i class="material-icons">find_in_page </i> Pesquisar contrato de vendas</a>
						</div>
					</div>	
				</div>
			</div>
