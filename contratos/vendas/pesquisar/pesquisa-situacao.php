...
<html>
<head>
<title>Reparsul | Pesquisa :: Situação</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Situação de Contrato:</h4>
<?php

$begin = @$_GET['begin'];
if (!$begin) { $begin = 0; }
$situacao = $_POST['situacao'];						
$query = "SELECT COUNT(*) FROM contrato_vendas WHERE ve_situacao LIKE '%$situacao%'";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
$situacao = $_POST['situacao'];
$query = "SELECT DISTINCT * FROM contrato_vendas WHERE ve_situacao LIKE '%$situacao%'";
$query = mysql_query($query);
...
?> 
							<tbody> 
								<tr> 
									...
									<th style="background-color: aquamarine"><?php echo $linha['ve_situacao'] ?></th>
