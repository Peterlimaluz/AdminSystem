...
<html>
<head>
<title>Reparsul | Pesquisa :: Dia de Vencimento</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Dia de Vencimento:</h4>
<?php

$begin = @$_GET['begin'];
if (!$begin) { $begin = 0; }
$dia = $_POST['vencimento'];						
$query = "SELECT COUNT(*) FROM contrato_vendas WHERE ve_vencimento LIKE '%$dia%'";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
$dia= $_POST['vencimento'];
$query = "SELECT DISTINCT * FROM contrato_vendas WHERE ve_vencimento LIKE '%$dia%'";
$query = mysql_query($query);
...
?> 
							<tbody> 
								<tr> 
									...
									<th style="background-color: aquamarine"><?php echo $linha['ve_vencimento'] ?></th>
