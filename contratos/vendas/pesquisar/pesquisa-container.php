...
<html>
<head>
<title>Reparsul | Pesquisa :: Container</title>
...
?> 
							<tbody> 
								<tr title="<?php echo $linha['ve_idOne']?><?php if($linha['ve_idTwo'] == ''){}else{?> | <?php echo $linha['ve_idTwo']; }?><?php if($linha['ve_idThree'] == ''){}else{?> | <?php echo $linha['ve_idThree']; }?><?php if($linha['ve_idFour'] == ''){}else{?> | <?php echo $linha['ve_idFour']; }?><?php if($linha['ve_idFive'] == ''){}else{?> | <?php echo $linha['ve_idFive']; }?><?php if($linha['ve_idSix'] == ''){}else{?> | <?php echo $linha['ve_idSix']; }?><?php if($linha['ve_idSev'] == ''){}else{?> | <?php echo $linha['ve_idSev']; }?><?php if($linha['ve_idEig'] == ''){}else{?> | <?php echo $linha['ve_idEig']; }?><?php if($linha['ve_idNine'] == ''){}else{?> | <?php echo $linha['ve_idNine']; }?><?php if($linha['ve_idTen'] == ''){}else{?> | <?php echo $linha['ve_idTen']; }?><?php if($linha['ve_idTenO'] == ''){}else{?> | <?php echo $linha['ve_idTenO']; }?><?php if($linha['ve_idTenTwo'] == ''){}else{?> | <?php echo $linha['ve_idTenTwo']; }?><?php if($linha['ve_idTenThree'] == ''){}else{?> | <?php echo $linha['ve_idTenThree']; }?><?php if($linha['ve_idTenFour'] == ''){}else{?> | <?php echo $linha['ve_idTenFour']; }?><?php if($linha['ve_idTenFive'] == ''){}else{?> | <?php echo $linha['ve_idTenFive']; }?>"> 
									<th scope="row"><?php echo $linha['ve_id'] ?></th> 
									<th style="background-color: aquamarine"><?php echo $linha['ve_cpf'] ?></th> 
									<td><?php echo $data ?></td> 
									<td><?php echo $linha['ve_nome'] ?></td>
									<td><?php echo $linha['ve_canal'] ?></td>
									<td><?php echo $linha['ve_situacao'] ?></td>
									<td><?php echo $linha['ve_faforma'] ?></td>
