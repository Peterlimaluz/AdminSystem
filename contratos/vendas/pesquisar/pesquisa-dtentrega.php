...
<html>
<head>
<title>Reparsul | Pesquisa :: Data de Entrega</title>
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">border_color </i> Pesquisa Contrato de Vendas</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Data de Entrega:</h4>
<?php
...
$fim = $_POST['dtfim'];					
$query = "SELECT COUNT(*) FROM contrato_vendas WHERE ve_dtentrega BETWEEN ('$inicio') AND ('$fim')";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
$inicio = $_POST['dtinicio'];
$fim = $_POST['dtfim'];
$query = "SELECT DISTINCT * FROM contrato_vendas WHERE ve_dtentrega BETWEEN ('$inicio') AND ('$fim')";
$query = mysql_query($query);
...
?> 
							<tbody> 
								<tr> 
									...
									<th style="background-color: aquamarine"><?php echo $dataE ?></th> 
