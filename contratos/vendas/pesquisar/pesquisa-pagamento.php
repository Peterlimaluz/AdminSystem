...
<html>
<head>
<title>Reparsul | Pesquisa :: Tipo de Pagamento</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Tipo de Pagamento:</h4>
<?php

$begin = @$_GET['begin'];
if (!$begin) { $begin = 0; }
$tipo = $_POST['pag'];						
$query = "SELECT COUNT(*) FROM contrato_vendas WHERE ve_pag LIKE '%$tipo%'";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
$tipo= $_POST['pag'];
$query = "SELECT DISTINCT * FROM contrato_vendas WHERE ve_pag LIKE '%$tipo%'";
$query = mysql_query($query);
...
?> 
							<tbody> 
								<tr> 
									...
									<th style="background-color: aquamarine"><?php echo $linha['ve_pag'] ?></th>
