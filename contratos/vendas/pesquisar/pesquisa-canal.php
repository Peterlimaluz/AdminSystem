...
<html>
<head>
<title>Reparsul | Pesquisa :: Canal</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Canal de Venda:</h4>
<?php

$begin = @$_GET['begin'];
if (!$begin) { $begin = 0; }
$canal = $_POST['canal'];						
$query = "SELECT COUNT(*) FROM contrato_vendas WHERE ve_canal LIKE '%$canal%'";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
?> 
							<tbody> 
								<tr> 
									...
									<th style="background-color: aquamarine"><?php echo $linha['ve_canal'] ?></th>
