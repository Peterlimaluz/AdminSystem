...
<html>
<head>
<title>Reparsul | Pesquisa :: CPF/CNPJ</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Número de CPF/CNPJ do Cliente:</h4>
<?php

$begin = @$_GET['begin'];
if (!$begin) { $begin = 0; }
$cpf = $_POST['cpf'];						
$query = "SELECT COUNT(*) FROM contrato_vendas WHERE ve_cpf LIKE '%$cpf%'";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
$cpf = $_POST['cpf'];
$query = "SELECT DISTINCT * FROM contrato_vendas WHERE ve_cpf LIKE '%$cpf%'";
$query = mysql_query($query);
