...
<html>
<head>
<title>Reparsul | Pesquisa :: Forma de Pagamento</title>
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">border_color </i> Pesquisa Por Forma de Pagamento</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Forma de Pagamento:</h4>
<?php

$begin = @$_GET['begin'];
if (!$begin) { $begin = 0; }
$forma = $_POST['forma'];						
$query = "SELECT COUNT(*) FROM contrato_vendas WHERE ve_forma LIKE '%$forma%'";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
$forma = $_POST['forma'];
$query = "SELECT DISTINCT * FROM contrato_vendas WHERE ve_forma LIKE '%$forma%'";
$query = mysql_query($query);
...
?> 
							<tbody> 
								<tr> 
									...
									<th style="background-color: aquamarine"><?php echo $linha['ve_forma'] ?></th>
