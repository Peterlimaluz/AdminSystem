...
<html>
<head>
<title>Reparsul | Vendas :: Alterar</title>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="search-box">
					<form class="input">
						<a href="#" style="color: slateblue; font-weight: 600; text-transform: uppercase;"><div class="titlePg">Contrato Locação</div></a>
					</form>
				</div><!--//end-search-box-->
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">border_color </i> Alterar Contrato de Locação</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Clique no botão ao lado para alterar e expandir as opções:</h4>
<?php
...
?>
				...
				<h3>Total de Contratos Cadastrados : <strong style="color: crimson;"><?php echo $total ?></strong></h3>
							<br>
...
$query = 'SELECT DISTINCT * FROM contrato_vendas ORDER BY `ve_id` DESC LIMIT '.$begin.' , 10';
$query = mysql_query($query);
...
?> 
							<tbody> 
								<tr> 
									...
									<td><?php echo $linha['ve_vencimento'] ?></td>
									<td><?php echo $linha['ve_forma'] ?></td>
									<td><a class="btn btn-danger" id="noprint" data-toggle="collapse" href="#<?php echo $linha['ve_id'] ?>" role="button" aria-expanded="false" aria-controls="<?php echo $linha['ve_id'] ?>"><i class="fa fa-plus-square nav_icon"></i></a></td>
								</tr>
							</tbody>
							...
							<div class="modal fade in" id="alterar<?php echo $linha['ve_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="alterar<?php echo $linha['ve_id'] ?>Label">
							  <div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
								  ...
								  <div class="modal-body">
									<form action="../../../sql/update-venda.php" method="post">
										...
										<hr>
								<div class="row"><u><i><a data-toggle="collapse" data-parent="#accordion" href="#collapseP1<?php echo $linha['ve_id'] ?>" aria-expanded="false" aria-controls="collapseP1<?php echo $linha['ve_id'] ?>">Produtos 1:</a></i></u></div>
								<div id="collapseP1<?php echo $linha['ve_id'] ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingP1<?php echo $linha['ve_id'] ?>">
								<div class="row">
									<div class="col-md-3">
								...
								<div class="row">
									<div class="col-md-2">
										...
										<input type="text" class="form-control" name="ve_idOne" id="codigo" placeholder="Cod. Produto :" value="<?php echo $linha['ve_idOne'] ?>" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										...
										<input type="text" name="ve_quantOne" id="quant1" onKeyUp="calcular(this.value)" class="form-control" placeholder="Quantidade :" value="<?php echo $linha['ve_quantOne'] ?>">
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorOne" id="valor" onKeyUp="calcular(this.value)" class="form-control" placeholder="Valor Unitario:" value="<?php echo $linha['ve_valorOne'] ?>">
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTOne" id="valorT" onKeyUp="calcular(this.value)" class="form-control" placeholder="Valor Unitario:" value="<?php echo $linha['ve_valorTOne'] ?>">
									</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<input type="button" class="btn btn-danger" value="Limpa Produto 2" onClick="limpaCo2()">
									</div>
								</div>
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idTwo" id="codigo2" value="<?php echo $linha['ve_idTwo'] ?>" placeholder="Cod. Produto 2 :" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod2').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantTwo" id="quant2" onKeyUp="calcular(this.value)" class="form-control" value="<?php echo $linha['ve_quantTwo'] ?>" placeholder="Quantidade 2:">
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorTwo" id="valor2" onKeyUp="calcular(this.value)" value="<?php echo $linha['ve_valorTwo'] ?>" class="form-control" placeholder="Valor Unitario 2:">
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTTwo" id="valorT2" onKeyUp="calcular(this.value)" value="<?php echo $linha['ve_valorTTwo'] ?>" class="form-control" placeholder="Valor Unitario 2:">
									</div>
									...
									document.getElementById('valorT2').value="";
									document.getElementById('largura2').value="";
									document.getElementById('comprimento2').value="";
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idThree" value="<?php echo $linha['ve_idThree'] ?>" id="codigo3" placeholder="Cod. Produto 3:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod3').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantThree" id="quant3" onKeyUp="calcular(this.value)" value="<?php echo $linha['ve_quantThree'] ?>" class="form-control" placeholder="Quantidade 3:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorThree" onKeyUp="calcular(this.value)" value="<?php echo $linha['ve_valorThree'] ?>" id="valor3" class="form-control" placeholder="Valor Unitario 3:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTThree" onKeyUp="calcular(this.value)" value="<?php echo $linha['ve_valorTThree'] ?>" id="valorT3" class="form-control" placeholder="Valor Total 3:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idFour" id="codigo4" value="<?php echo $linha['ve_idFour'] ?>" placeholder="Cod. Produto 4:" style="text-transform: uppercase;">
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantFour" id="quant4" oonKeyUp="calcular(this.value)" value="<?php echo $linha['ve_quantFour'] ?>" class="form-control" placeholder="Quantidade 4:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorFour" onKeyUp="calcular(this.value)" value="<?php echo $linha['ve_valorFour'] ?>" id="valor4" class="form-control" placeholder="Valor Unitario 4:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTFour" onKeyUp="calcular(this.value)"value="<?php echo $linha['ve_valorTFour'] ?>" id="valorT4" class="form-control" placeholder="Valor Unitario 4:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idFive" value="<?php echo $linha['ve_idFive'] ?>" id="codigo5" placeholder="Cod. Produto 5:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod5').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantFive" onKeyUp="calcular(this.value)" id="quant5" value="<?php echo $linha['ve_quantFive'] ?>" class="form-control" placeholder="Quantidade 5:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorFive" onKeyUp="calcular(this.value)" id="valor5" value="<?php echo $linha['ve_valorFive'] ?>" class="form-control" placeholder="Valor Unitario 5:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTFive" onKeyUp="calcular(this.value)" id="valorT5" value="<?php echo $linha['ve_valorTFive'] ?>" class="form-control" placeholder="Valor Unitario 5:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idSix" value="<?php echo $linha['ve_idSix'] ?>" id="codigo6" placeholder="Cod. Produto 6:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod6').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantSix" onKeyUp="calcular(this.value)" id="quant6" value="<?php echo $linha['ve_quantSix'] ?>" class="form-control" placeholder="Quantidade 6:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorSix" onKeyUp="calcular(this.value)" id="valor6" value="<?php echo $linha['ve_valorSix'] ?>" class="form-control" placeholder="Valor Unitario 6:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTSix" onKeyUp="calcular(this.value)" id="valor6" value="<?php echo $linha['ve_valorTSix'] ?>" class="form-control" placeholder="Valor Unitario 6:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idSev" value="<?php echo $linha['ve_idSev'] ?>" id="codigo7" placeholder="Cod. Produto 7:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod7').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantSev" onKeyUp="calcular(this.value)" id="quant7" value="<?php echo $linha['ve_quantSev'] ?>" class="form-control" placeholder="Quantidade 7:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorSev" onKeyUp="calcular(this.value)" id="valor7" value="<?php echo $linha['ve_valorSev'] ?>" class="form-control" placeholder="Valor Unitario 7:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTSev" onKeyUp="calcular(this.value)" id="valor7" value="<?php echo $linha['ve_valorTSev'] ?>" class="form-control" placeholder="Valor Unitario 7:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idEig" value="<?php echo $linha['ve_idEig'] ?>" id="codigo8" placeholder="Cod. Produto 5:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod8').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantEig" onKeyUp="calcular(this.value)" id="quant8" value="<?php echo $linha['ve_quantEig'] ?>" class="form-control" placeholder="Quantidade 8:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorEig" onKeyUp="calcular(this.value)" id="valor8" value="<?php echo $linha['ve_valorEig'] ?>" class="form-control" placeholder="Valor Unitario 8:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTEig" onKeyUp="calcular(this.value)" id="valor8" value="<?php echo $linha['ve_valorTEig'] ?>" class="form-control" placeholder="Valor Unitario 8:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idNine" value="<?php echo $linha['ve_idNine'] ?>" id="codigo9" placeholder="Cod. Produto 9:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod9').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantNine" onKeyUp="calcular(this.value)" id="quant9" value="<?php echo $linha['ve_quantNine'] ?>" class="form-control" placeholder="Quantidade 5:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorNine" onKeyUp="calcular(this.value)" id="valor9" value="<?php echo $linha['ve_valorNine'] ?>" class="form-control" placeholder="Valor Unitario 9:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTNine" onKeyUp="calcular(this.value)" id="valor9" value="<?php echo $linha['ve_valorTNine'] ?>" class="form-control" placeholder="Valor Unitario 9:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idTen" value="<?php echo $linha['ve_idTen'] ?>" id="codigo10" placeholder="Cod. Produto 10:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod10').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantTen" onKeyUp="calcular(this.value)" id="quant10" value="<?php echo $linha['ve_quantTen'] ?>" class="form-control" placeholder="Quantidade 10:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorTen" onKeyUp="calcular(this.value)" id="valor10" value="<?php echo $linha['ve_valorTen'] ?>" class="form-control" placeholder="Valor Unitario 10:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTTen" onKeyUp="calcular(this.value)" id="valor10" value="<?php echo $linha['ve_valorTTen'] ?>" class="form-control" placeholder="Valor Unitario 10:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idTenO" value="<?php echo $linha['ve_idTenO'] ?>" id="codigo11" placeholder="Cod. Produto 11:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod11').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantTenO" onKeyUp="calcular(this.value)" id="quant11" value="<?php echo $linha['ve_quantTenO'] ?>" class="form-control" placeholder="Quantidade 11:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorTenO" onKeyUp="calcular(this.value)" id="valor11" value="<?php echo $linha['ve_valorTenO'] ?>" class="form-control" placeholder="Valor Unitario 11:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTTenO" onKeyUp="calcular(this.value)" id="valor11" value="<?php echo $linha['ve_valorTTenO'] ?>" class="form-control" placeholder="Valor Unitario 11:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idTenTwo" value="<?php echo $linha['ve_idTenTwo'] ?>" id="codigo12" placeholder="Cod. Produto 12:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod12').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantTenTwo" onKeyUp="calcular(this.value)" id="quant12" value="<?php echo $linha['ve_quantTenTwo'] ?>" class="form-control" placeholder="Quantidade 12:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorTenTwo" onKeyUp="calcular(this.value)" id="valor12" value="<?php echo $linha['ve_valorTenTwo'] ?>" class="form-control" placeholder="Valor Unitario 12:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTTenTwo" onKeyUp="calcular(this.value)" id="valor12" value="<?php echo $linha['ve_valorTTenTwo'] ?>" class="form-control" placeholder="Valor Unitario 12:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idTenThree" value="<?php echo $linha['ve_idTenThree'] ?>" id="codigo13" placeholder="Cod. Produto 13:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod13').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantTenThree" onKeyUp="calcular(this.value)" id="quant13" value="<?php echo $linha['ve_quantTenThree'] ?>" class="form-control" placeholder="Quantidade 13:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorTenThree" onKeyUp="calcular(this.value)" id="valor13" value="<?php echo $linha['ve_valorTenThree'] ?>" class="form-control" placeholder="Valor Unitario 13:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTTenThree" onKeyUp="calcular(this.value)" id="valor13" value="<?php echo $linha['ve_valorTTenThree'] ?>" class="form-control" placeholder="Valor Unitario 13:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idTenFour" value="<?php echo $linha['ve_idTenFour'] ?>" id="codigo14" placeholder="Cod. Produto 14:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod14').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantTenFour" onKeyUp="calcular(this.value)" id="quant14" value="<?php echo $linha['ve_quantTenFour'] ?>" class="form-control" placeholder="Quantidade 14:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorTenFour" onKeyUp="calcular(this.value)" id="valor14" value="<?php echo $linha['ve_valorTenFour'] ?>" class="form-control" placeholder="Valor Unitario 14:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTTenFour" onKeyUp="calcular(this.value)" id="valor14" value="<?php echo $linha['ve_valorTTenFour'] ?>" class="form-control" placeholder="Valor Unitario 14:"/>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<label>Código</label>
										<input class="form-control" name="ve_idTenFive" value="<?php echo $linha['ve_idTenFive'] ?>" id="codigo15" placeholder="Cod. Produto 15:" style="text-transform: uppercase;">
										<script type="application/javascript">
											$('#cod15').mask('***********');
										</script>
									</div>
									...
									<div class="col-md-2">
										<label>Quantidade</label>
										<input type="text" name="ve_quantTenFive" onKeyUp="calcular(this.value)" id="quant15" value="<?php echo $linha['ve_quantTenFive'] ?>" class="form-control" placeholder="Quantidade 15:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Unitário</label>
										<input type="text" name="ve_valorTenFive" onKeyUp="calcular(this.value)" id="valor15" value="<?php echo $linha['ve_valorTenFive'] ?>" class="form-control" placeholder="Valor Unitario 15:"/>
									</div>
									<div class="col-md-3">
										<label>Valor Total</label>
										<input type="text" name="ve_valorTTenFive" onKeyUp="calcular(this.value)" id="valor15" value="<?php echo $linha['ve_valorTTenFive'] ?>" class="form-control" placeholder="Valor Unitario 15:"/>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-3 col-xs-12">
										<label>Valor Total</label>
										<input type="text" class="form-control" onKeyUp="calcular(this.value)" name="ve_total" id="Total" value="<?php echo $linha['ve_total']?>" placeholder="Valor Total:">
									</div>
								  </div>
								  <div class="row">
...
if (VERSION > 3) { 
document.write('<form><input class="btn btn-default" type=button value="IMPRIMIR TODOS OS REGISTROS" name="Print" onClick="printit()"></form>'); 
}
</script>
								</div>
								<div class="col-md-6"><a class="btn btn-success" href="excel.php"><i class="fa fa-file-excel"></i> Excel</a></div>
							</div>
</div>
						<hr>
					</div>			
