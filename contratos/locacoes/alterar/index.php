...
<html>
<head>
<title>Reparsul | Locações :: Alterar</title>
...
$query = 'SELECT DISTINCT * FROM contrato_locacao ORDER BY `lo_id` DESC LIMIT '.$begin.' , 5';
$query = mysql_query($query);
...
?> 
							<tbody> 
								<tr> 
									...
									<td><?php echo $data ?></td>
									<td><?php echo $linha['lo_situacao'] ?></td>
									<td><?php echo $linha['lo_fadia'] ?></td>
									<td><?php echo $linha['lo_faforma'] ?></td>
									<td><a class="btn btn-danger" id="noprint" data-toggle="collapse" href="#<?php echo $linha['lo_id'] ?>" role="button" aria-expanded="false" aria-controls="<?php echo $linha['lo_id'] ?>"><i class="fa fa-plus-square nav_icon"></i></a></td>
								</tr>
							</tbody>
							...
							<div class="modal fade" id="alterar<?php echo $linha['lo_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="alterar<?php echo $linha['lo_id'] ?>Label">
							  <div class="modal-dialog modal-lg" role="document">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<input type="text" class="form-control input-lg" name="lo_valReposicao" id="reposicao" value="<?php echo $linha['lo_valReposicao']?>" placeholder="Valor De Reposição:">
										<script>
										$(function(){
