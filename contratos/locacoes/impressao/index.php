...
<html>
<head>
<title>Reparsul | Pesquisa :: Impressão</title>
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">search </i> - TELA DE IMPRESSÃO DO RECIBO GERADO</h3>
...
$query = "SELECT lo_id FROM contrato_locacao ORDER BY lo_id DESC LIMIT 1";
$query = mysql_query($query);
...
?> 
						<div class="row">
							<div align="center" class="col-md-12 col-xs-12">
								<label>Código de Controle de Pátio : </label><label class="alert alert-success"> <?php echo $linha['lo_id']?></label>
							</div>
						</div>
						<br>
						<div class="row">
							<div align="center" class="col-md-12 col-xs-12">
								<form action="../pesquisar/imprimir.php" id="atender" name="atender" method="post">
									...
									<button type="submit" class="btn btn-warning btn-lg"><i class="material-icons">local_printshop </i> Imprimir Contrato de Locação</button>
								</form>
							</div>
						</div>
