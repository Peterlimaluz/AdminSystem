...
<html>
<head>
<title>Reparsul | Locação :: Pesquisar</title>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="search-box">
					<form class="input">
						<a href="#" style="color: slateblue; font-weight: 600; text-transform: uppercase;"><div class="titlePg">PESquisar Locação</div></a>
					</form>
				</div><!--//end-search-box-->
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">border_color </i> Pesquisar Registros de Contrato de Locação</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Clique no botão do campo que será utilizado para pesquisar o Contrato de Locação:</h4>
						<br>
						<div align="center" class="row">
							  ...
							  <div class="modal-dialog">
								<div class="modal-content">
								  ...
								  <div class="modal-body">
									<form name="form_dtgeracao" method="post">
										<div class="row">
								  ...
								  <div class="modal-footer">
										...
										<input type="submit" class="btn btn-info" onclick="buscarOne();" value="Buscar"/>
										<button type="submit" class="btn btn-success" onclick="excelOne();" ><i class="fa fa-file-excel"></i> Excel</button>
												 </form>
												  <script language="Javascript">
													...
													function excelOne()
													{
														document.form_dtgeracao.action = "excel/excel-dtgerar.php"
										...
										<div class="modal-content">
										  <div class="modal-header">
											...
											<h4 class="modal-title" id="Cnpj">Pesquisa por Cpf/Cnpj</h4>
											  ...
											  <div class="modal-footer">
													<button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
													<input type="submit" class="btn btn-info" onclick="buscarTwo();" value="Buscar"/>
										<button type="submit" class="btn btn-success" onclick="excelTwo();" ><i class="fa fa-file-excel"></i> Excel</button>
												 </form>
												  <script language="Javascript">
													function buscarTwo()
													{
											...
											<h4 class="modal-title" id="con">Pesquisa por Número de Container</h4>
											  ...
											  <div class="modal-body">
												<form name="form_container" method="post">
													<div class="row">
														<input type="text" name="container" class="form-control" placeholder="Número do Contrato:" id="cod">
								...
								<button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#dtRetirada">
								  Data de Retirada
								</button>
								<!-- Modal -->
								<div class="modal fade" id="dtRetirada" tabindex="-1" role="dialog" aria-labelledby="retirada" aria-hidden="true">
							 		<div class="modal-dialog">
										<div class="modal-content">
										  <div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
											<h4 class="modal-title" id="retirada">Pesquisa por Data de Retirada</h4>
										  </div>
											  <div class="modal-body">
												<form name="form_dtretirada" method="post">
													<div class="row">
														<input type="date" name="dtInicio" class="form-control" placeholder="Data Inicial:" >
													</div>
													<div class="row">
										...
										<button type="submit" class="btn btn-success" onclick="excelFour();" ><i class="fa fa-file-excel"></i> Excel</button>
												  ...
												  <script language="Javascript">
													function buscarFour()
													{
														document.form_dtretirada.action = "pesquisa-dtretirada.php";
														// document.Form1.target = "_blank";    // Open in a new window
														document.form_dtretirada.submit();             // Submit the page
														return true;
													}

													function excelThree()
													{
														document.form_dtretirada.action = "excel/excel-dtretirada.php"
														//document.form_check.target = "_blank";    // Open in a new window
											...
											<h4 class="modal-title" id="forma">Pesquisa por Forma de Pagamento</h4>
											  ...
											  <div class="modal-body">
												<form name="form_forma" method="post">
													<div class="row">
														<select name="faforma" class="form-control">
							...
							<div class="row">
							 		...
							 		<div class="modal-dialog">
										<div class="modal-content">
										  <div class="modal-header">
											...
											<h4 class="modal-title" id="diaF">Pesquisa por Dia de Faturamento</h4>
											  ...
											  <div class="modal-body">
												<form name="form_dias.php" method="post">
													<div class="row">
										...
										<button type="submit" class="btn btn-success" onclick="excelSev();" ><i class="fa fa-file-excel"></i> Excel</button>
												  ...
												  <script language="Javascript">
													function buscarSev()
													{
														document.form_dias.action = "pesquisa-dias.php";
														// document.Form1.target = "_blank";    // Open in a new window
														document.form_dias.submit();             // Submit the page
														return true;
													}

													function excelSev()
													{
														document.form_dias.action = "excel/excel-dias.php"
														//document.form_check.target = "_blank";    // Open in a new window
								...
								<button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#tipoContrato">
								  Tipo de Contrato
								</button>
								<!-- Modal -->
								<div class="modal fade" id="tipoContrato" tabindex="-1" role="dialog" aria-labelledby="Co" aria-hidden="true">
							 		<div class="modal-dialog">
										<div class="modal-content">
										  <div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
											<h4 class="modal-title" id="Co">Pesquisa por Tipo de Contrato</h4>
										  </div>
											  <div class="modal-body">
												<form name="form_tipo" method="post">
													<div class="row">
										...
										<button type="submit" class="btn btn-success" onclick="excelNine();" ><i class="fa fa-file-excel"></i> Excel</button>
												  ...
												  <script language="Javascript">
													...
													function excelNine()
													{
														document.form_tipo.action = "excel/excel-tipo.php"
														//document.form_check.target = "_blank";    // Open in a new window
										...
										<div class="modal-content">
										  <div class="modal-header">
											...
											<h4 class="modal-title" id="contra">Pesquisa por Número de Contrato</h4>
											  ...
											  <div class="modal-footer">
													<button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
													<input type="submit" class="btn btn-info" onclick="buscarTen();" value="Buscar"/>
										<button type="submit" class="btn btn-success" onclick="excelTen();" ><i class="fa fa-file-excel"></i> Excel</button>
												 </form>
												  <script language="Javascript">
													function buscarTen()
													{
