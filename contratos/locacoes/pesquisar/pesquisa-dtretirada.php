...
<html>
<head>
<title>Reparsul | Pesquisa :: Data de Retirada</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Data de Retirada:</h4>
<?php
$inicio = $_POST['dtInicio'];
$fim = $_POST['dtFinal'];					
$query = "SELECT COUNT(*) FROM contrato_locacao WHERE lo_rdentrega BETWEEN ('$inicio') AND ('$fim')";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
?>
