...
<html>
<head>
<title>Reparsul | Orçamento :: Impressão</title>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="search-box">
					<form class="input">
						<a href="#" style="color: slateblue; font-weight: 600; text-transform: uppercase;"><div class="titlePg">Impressão</div></a>
					</form>
				</div><!--//end-search-box-->
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">search </i> - TELA DE IMPRESSÃO DE ORÇAMENTO</h3>
...
$query = "SELECT orca_id FROM orcamento ORDER BY orca_id DESC LIMIT 1";
$query = mysql_query($query);
...
?> 
						<div class="row">
							<div align="center" class="col-md-12 col-xs-12">
								<label>Registro do Orçamento : </label><label class="alert alert-success"> <?php echo $linha['orca_id']?></label>
							</div>
						</div>
						<br>
						<div class="row">
							<div align="center" class="col-md-12 col-xs-12">
								<form action="../pesquisar/imprimir.php" id="atender" name="atender" method="post">
									...
									<button type="submit" class="btn btn-warning btn-lg"><i class="material-icons">local_printshop </i> Imprimir Orçamento</button>
								</form>
							</div>
						</div>
