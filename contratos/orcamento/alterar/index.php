...
<html>
<head>
<title>Reparsul | Orçamento :: Alterar</title>
...
?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"><i class="material-icons">border_color </i> Alterar Contrato de Orçamento</h3>
...
?>
				...
				<h3>Total de Orçamentos Cadastrados : <strong style="color: crimson;"><?php echo $total ?></strong></h3>
							<br>
...
$query = 'SELECT DISTINCT * FROM orcamento ORDER BY orca_id DESC LIMIT '.$begin.' , 10' ;
$query = mysql_query($query);
