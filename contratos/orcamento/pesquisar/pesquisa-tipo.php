...
<html>
<head>
<title>Reparsul | Pesquisa :: Tipo de Orçamento</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por Tipo de Orçamento:</h4>
<?php

$begin = @$_GET['begin'];
if (!$begin) { $begin = 0; }
$tipo = $_POST['pag'];						
$query = "SELECT COUNT(*) FROM orcamento WHERE orca_tipo LIKE '%$tipo%'";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
$tipo = $_POST['pag'];
$query = "SELECT DISTINCT * FROM orcamento WHERE orca_tipo LIKE '%$tipo%' ORDER BY orca_id DESC";
$query = mysql_query($query);
