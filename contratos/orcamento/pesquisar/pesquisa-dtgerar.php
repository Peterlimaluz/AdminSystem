...
<html>
<head>
<title>Reparsul | Pesquisa :: Data Geração</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Pesquisa por data de Geração:</h4>
<?php
$inicio = $_POST['dtInicio'];
$fim = $_POST['dtFinal'];
$begin = @$_GET['begin'];
if (!$begin) { $begin = 0; }					
$query = "SELECT COUNT(*) FROM orcamento WHERE orca_dtgerado BETWEEN ('$inicio') AND ('$fim')";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
$inicio = $_POST['dtInicio'];
$fim = $_POST['dtFinal'];
$query = "SELECT DISTINCT * FROM orcamento WHERE orca_dtgerado BETWEEN ('$inicio') AND ('$fim') ORDER BY orca_id DESC";
$query = mysql_query($query);
