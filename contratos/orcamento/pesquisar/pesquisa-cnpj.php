...
if (!$begin) { $begin = 0; }
$cpf = $_POST['cpf'];					
$query = "SELECT COUNT(*) FROM orcamento WHERE orca_cpf LIKE '%$cpf%'";
$query = mysql_query($query);
$query = mysql_fetch_array($query);
$total = $query[0];
...
?>
				...
				<h3>Total de Orçamento Cadastrados : <strong style="color: crimson;"><?php echo $total ?></strong></h3>
							<br>
...
$cpf = $_POST['cpf'];
$query = "SELECT DISTINCT * FROM orcamento WHERE orca_cpf LIKE '%$cpf%' ORDER BY orca_id DESC";
$query = mysql_query($query);
